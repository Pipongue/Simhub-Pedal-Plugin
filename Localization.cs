    ...
    public static class Localization
    {
        ...
        private static readonly Dictionary<string, (string Fr, string En)> Strings = new Dictionary<string, (string Fr, string En)>
        {
            ...
            ["Settings.ConfirmInstallBody"] = ("Télécharger et installer la version {0} ?\n\nLa mise à jour sera appliquée automatiquement à la prochaine fermeture de SimHub.",
                                                 "Download and install version {0}?\n\nThe update will be applied automatically the next time SimHub closes."),
            ["Settings.UpdateReady"] = ("Mise à jour {0} prête — sera installée à la prochaine fermeture de SimHub.",
                                          "Update {0} ready — will be installed the next time SimHub closes."),
            ...
            ["Settings.ConfirmRevertBody"] = ("Revenir à la version stable {0} ?\n\nCette opération remplacera la version actuelle ({1}) à la prochaine fermeture de SimHub.",
                                                "Revert to stable version {0}?\n\nThis will replace the current version ({1}) the next time SimHub closes."),
            ["Settings.RevertReady"] = ("Retour à la version {0} programmé — sera installé à la prochaine fermeture de SimHub.",
                                         "Revert to version {0} scheduled — will be installed the next time SimHub closes."),
